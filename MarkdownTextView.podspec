#
# Be sure to run `pod lib lint MarkdownTextView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = "0.1.0"
  s.summary          = "A short description of MarkdownTextView."
...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  ...
  #s.resource_bundles = {
  #  'MarkdownTextView' => ['Pod/Assets/*.png']
  #}
